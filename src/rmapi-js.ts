...
import { type JtdSchema, validate } from './validate'
...
export type FetchLike = (url: string, options?: RequestInitLike | undefined) => Promise<ResponseLike>
...
class Remarkable implements RemarkableApi {
  ...
  readonly #cache = new Map<string, Promise<ArrayBuffer | null>>()
  ...
  async putCollection (
    ...
    const entryPromises: Array<Promise<Entry>> = []
