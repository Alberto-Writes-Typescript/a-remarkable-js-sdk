...
describe('NodeClient', () => {
  ...
  describe ('.get', () => {
    ...
    it ('performs request with given request payload', () => {
      ...
      const mock = mockHttpsRequest(host, path, method, headers)

      NodeClient.get(host, path, headers)
  ...
  describe ('.post', () => {
    ...
    it ('performs request with given request payload', () => {
      ...
      NodeClient.post(host, path, headers)
  ...
  describe ('.patch', () => {
    ...
    it ('performs request with given request payload', () => {
      ...
      NodeClient.patch(host, path, headers)
  ...
  describe ('.put', () => {
    ...
    it ('performs request with given request payload', () => {
      ...
      NodeClient.put(host, path, headers)
  ...
  describe ('.delete', () => {
    ...
    it ('performs request with given request payload', () => {
      ...
      NodeClient.delete(host, path, headers)
